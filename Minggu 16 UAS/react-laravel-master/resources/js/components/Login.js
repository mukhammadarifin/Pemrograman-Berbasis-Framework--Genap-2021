                ...
                >
                    <div className="auth-form-light text-left p-5 animated fadeIn">
                        <div className="brand-logo">
                            <h1 className="text-center" style={{color: '#1E90FF'}}>{global.variables.site_name}</h1>
                        </div>
                        <h4>Selamat datang, silahkan masukkan username dan password anda.</h4>
                        <form className="pt-3" ref={c => { this.form = c }} onSubmit={this.onSubmitHandle}>
                            ...
                            <div className="mt-3">
                                <button type="submit" className="btn btn-block btn-gradient-info btn-lg font-weight-medium auth-form-btn" >
                                    SIGN IN
                                </button>
                            </div>

                            <div className="text-center mt-4 font-weight-light"> Belum punya akun? <Link to='/registration' className="text-info">klik disini</Link >
                            </div>
                        </form>
                    </div>
                    </LoadingOverlay>
