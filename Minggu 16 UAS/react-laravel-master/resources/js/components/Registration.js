            ...
            <React.Fragment>
                ...
                >
                    <div className="auth-form-light text-left p-5 animated fadeIn">
                        ...
                        <h4>Masih baru? Silahkan lengkapi formnya.</h4>
                        <form className="pt-3" ref={c => { this.form = c }} onSubmit={this.onSubmitHandle}>
                            ...
                            <div className="mt-3">
                                <button type="submit" className="btn btn-block btn-gradient-info btn-lg font-weight-medium auth-form-btn" >SIGN UP</button>
                            </div>
                            <div className="text-center mt-4 font-weight-light"> Sudah punya akun? <Link to='/login' className="text-info">Login</Link>
                            </div>
                        </form>
                    </div>
                </LoadingOverlay>
