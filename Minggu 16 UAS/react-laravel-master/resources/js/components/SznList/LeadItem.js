                            ...
                            <div className="szn-widget__bottom d-flex flex-column flex-md-row">
                                <div className="szn-widget__item ">
                                    ...
                                    <div className="szn-widget__details d-flex flex-md-column flex-row">
                                        <span className="szn-widget__title">Penghasilan</span>
                                ...
                                <div className="szn-widget__item">
                                    ...
                                    <div className="szn-widget__details d-flex flex-md-column flex-row">
                                        <span className="szn-widget__title">Pengeluaran</span>
                                ...
                                <div className="szn-widget__item">
                                    ...
                                    <div className="szn-widget__details d-flex flex-md-column flex-row">
                                        <span className="szn-widget__title">Penghasilan (bersih)</span>
                                ...
                                <div className="szn-widget__item">
                                    ...
                                    <div className="szn-widget__details d-flex flex-md-column flex-row">
                                        <span className="szn-widget__title">Ditambahkan pada</span>
