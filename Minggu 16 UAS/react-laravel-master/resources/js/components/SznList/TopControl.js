                ...
                <div className="d-flex flex-column flex-md-row justify-content-md-between">
                    <div className="d-flex flex-row">
                        <div className="p-2">
                            <div className="input-group input-group-sm">
                                ...
                                <select className="form-control form-control-sm btn btn-info" disabled={props.isLoading ? true : false} defaultValue={props.perPage} onChange={props.onChangePerPageHandle}>
                    ...
                    <form className="p-2 col-md-4" onSubmit={props.onSubmitQueryHandle}>
                        <div className="input-group">
                            ...
                            <div className="input-group-append">
                                <button className="btn btn-sm btn-gradient-info" disabled={props.isLoading ? true : false} type="submit">Search</button>
                            </div>
                        </div>
                    </form>
                </div>
