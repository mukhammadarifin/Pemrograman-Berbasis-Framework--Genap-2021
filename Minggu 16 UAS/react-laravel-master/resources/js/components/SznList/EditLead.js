...
function EditLead(props) {
    ...
    useEffect(() => {
        document.title = 'Edit Data Pegawai';

        props.setActiveComponentProp('Edit Data Pegawai');
    }, []);
                                ...
                                >
                                    <form className="edit-lead-form border" onSubmit={onSubmitHandle}>
                                        ...
                                        <div className="form-group">
                                            <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                                <li className="nav-item">
                                                    <span className="nav-link btn btn-gradient-info btn-block active">EDIT LEAD</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="form-group">
                                        ...
                                        <div className="form-group text-center">
                                            <button type="submit" className="btn btn-gradient-info btn-md mr-2">Update</button>
