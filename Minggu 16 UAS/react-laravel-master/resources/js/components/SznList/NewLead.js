...
function NewLead(props) {
    ...
    useEffect(() => {
        document.title = 'Input Data Pegawai';

        props.setActiveComponentProp('Input Data Pegawai');
    }, []);
                                    ...
                                    <div className="form-group">
                                        <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                            <li className="nav-item">
                                                <span className="nav-link btn btn-gradient-info btn-block active">Input Data Pegawai</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="form-group">
