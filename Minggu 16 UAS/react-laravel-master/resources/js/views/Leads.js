			...
			<div className="page-header">
				<h3 className="page-title">
					<span className="page-title-icon bg-gradient-info text-white mr-2">
				 	...
				 	{ activeComponent && activeComponent == 'Data Pegawai' ?  
						'Data Pegawai' : (activeComponent && activeComponent == 'Input Data Pegawai' ? 'Input Data Pegawai' : 
						(activeComponent && activeComponent == 'Edit Data Pegawai' ? 'Edit Data Pegawai' : '' ) )
					}
				</h3>
